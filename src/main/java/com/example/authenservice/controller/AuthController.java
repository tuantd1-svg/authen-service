    ...
    public ResultMessage login(@Valid @RequestBody UserLogin userLogin) {
        try {
            ...
            JwtRDto jwtRDto = JwtRDto.builder()
                    ...
                    .isActive(userDetailsServices.isActive())
                    .isDelete(userDetailsServices.isDelete())
                    .isLocked(userDetailsServices.isLocked())
                    .token(jwt)
                    .roles(roles)
                    .build();
            ...
            LoggerUtils2.error(AuthController.class, "login", "exception", e);
